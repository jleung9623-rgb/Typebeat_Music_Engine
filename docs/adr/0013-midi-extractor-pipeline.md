...
### Decision
Implement a unidirectional extraction pipeline that parses raw MIDI files, isolates pitch/velocity/timing data, and strictly maps it to the `Motif` and `MotifNote` ORM entities prior to database insertion.
